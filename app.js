...
const ffmpeg = childProcess.spawn(
    ...
    [
        ...
        '-filter_complex', '[0:v]split=2[in1][in2];[in1]fps=20[out1];[in2]fps=1,format=gray,boxblur=5:3,ocr,mpdecimate,metadata=print:key=lavfi.ocr.text[out2]', // 10:2, ,mpdecimate. unsharp
